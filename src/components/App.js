...
const [charLimit, setCharLimit] = useState(50);
  ...
  return (
    <div id="main">
    Char Limit:-{""}
<input type = "number" defaultValue={charLimit} onChange={(e)=>{setCharLimit(e.target.value);}}/>
<input type = "color" defaultValue={color} onChange={(e)=>{setColor(e.target.value);}}/>
<input type ="text" defaultValue={inputText} maxLength={charLimit} onChange={(e)=>{setInputText(e.target.value);}}/>
